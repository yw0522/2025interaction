//把github上的MakerUno_DefaultSketch.ino程式碼複製過來
//寫一個myMusic函式，把for迴圈複製進去
#define NOTE_C5 523
#define NOTE_E5 659
#define NOTE_G5 784
...
void setup()
{
  ...
  for (int thisNote = 0; thisNote < 9; thisNote++) {  //複製整個for迴圈到myMusic
